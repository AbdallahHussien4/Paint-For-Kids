...
ToQuarter::ToQuarter(ApplicationManager * pApp):Action(pApp)
{
}
void ToQuarter::ReadActionParameters(){
	
	s=pManager->getSelectedFig();
	
}
void ToQuarter::Execute() {
	...
	if(dynamic_cast<CRectangle*>(s))
	{
		...
		pout->PrintMessage("Resize to quarter ");
