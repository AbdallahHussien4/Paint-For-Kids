...
ActionType Input::GetUserAction() const
{
	...
	if (UI.InterfaceMode == MODE_DRAW)	//GUI in the DRAW mode
	{
		...
		if (y >= 0 && y < UI.ToolBarHeight)
		{
			...
			case ITM_COPY:return copy1;
			case ITM_SELECT:return select1;
			case ITM_CUT:return cut;
			case ITM_PASTE:return paste;
			case ITM_quarter:return quarter;
			case ITM_half:return half;
			case ITM_double:return time2;
			case ITM_4times:return time4;
			case ITM_voice:return vooice;
	...
	else if(UI.InterfaceMode == MODE_PLAY)	//GUI is in PLAY mode
	{
		...
		if (y >= 0 && y < UI.ToolBarHeight)
		{
			...
			case ITM_FIGURETYPE1: return ITM_FIGURETYPE;
			case ITM_FIGURECOLOR1: return ITM_FIGURECOLOR;
			case ITM_EXITPLAYMODE:return EXIT;
